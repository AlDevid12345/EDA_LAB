...
df2 = pd.read_csv(
    r'D:\EDA_Lab\25EC01004\Sentaurus_TCAD\data\q_10_5nm_with_qf_idvd_vgs_0.csv'
)
...
plt.title(
    r'$I_D - V_{DS}$ with and without $Q_{f}$ at $V_{GS}$ = 0V and $t_{ox}$ = 5 nm ',
)
...
plt.tight_layout()
# plt.savefig(
#     'Q10.3_Id_Vds_qf=0_&_3.9e10_vgs=0_tox=5nm.png',
#     dpi = 300
# )
plt.show()
